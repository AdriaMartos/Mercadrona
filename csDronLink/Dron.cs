...
namespace csDronLink
{
    ...
    public partial class Dron
    {
        ...
        public void FijarHome(float latitud, float longitud, float altitud)
        {
            ...
            MAVLink.mavlink_command_long_t req = new MAVLink.mavlink_command_long_t
            {
                ...
                param1 = 0, // 0 = Usar las coordenadas de los params 5 y 6
                param2 = 0,
                param3 = 0,
                param4 = 0,
                param5 = latitud,
            ...
            Console.WriteLine($"Comando Set Home enviado a: {latitud}, {longitud}");
        }
        ...
        public void SmartRTL(Action<byte, object> callback = null)
        {
        ...
        public void Desconectar()
        {
            try
            {
                ...
                Console.WriteLine($"Dron {this.id} desconectado correctamente.");
            }
            catch (Exception ex)
            {
                Console.WriteLine($"Error al intentar desconectar el Dron {this.id}: {ex.Message}");
            }
        }
        public byte GetID()
        {
        ...
        public float GetAlt()
        {
            return this.relative_alt; // <-- OJO: Cambiar 'altura' por 'relative_alt'
        }
        ...
        // Método para guardar un mensaje con la hora actual
        public void RegistrarLog(string mensaje)
        {
            string hora = DateTime.Now.ToString("HH:mm:ss");
            _historial.Add($"[{hora}] {mensaje}");
        }

        // Método para devolver la lista completa de mensajes al formulario
